...
public final class FragmentListBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView listPOIs;

  private FragmentListBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView listPOIs) {
  ...
  public static FragmentListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.listPOIs;
      RecyclerView listPOIs = ViewBindings.findChildViewById(rootView, id);
      if (listPOIs == null) {
        break missingId;
      }

      return new FragmentListBinding((ConstraintLayout) rootView, listPOIs);
    }
